import { Github, Twitter, Linkedin, Mail, ExternalLink, Heart, Code2, Instagram } from "lucide-react"
import { SectionEyebrow } from "@/components/section-eyebrow"
import { profile } from "@/data/profile"

const socialLinks = [
  { label: "GitHub", href: profile.github, handle: "@rengarajkamatchinathan", icon: Github },
  { label: "X", href: profile.x, handle: profile.xHandle, icon: Twitter },
  { label: "LinkedIn", href: profile.linkedin, handle: "/in/rengarajkamatchinathan", icon: Linkedin },
  { label: "LeetCode", href: profile.leetcode, handle: "/u/rengaraj02k", icon: Code2 },
  { label: "Instagram", href: profile.instagram, handle: "@rengaraj_kamatchinathan", icon: Instagram },
