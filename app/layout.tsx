...
const siteTitle = `${profile.brand} — ${profile.tagline}`
...
export const metadata: Metadata = {
  ...
  keywords: ["Rengaraj Kamatchinathan", "Rengaraj K", "Full-Stack Engineer", "Software Engineer", "Next.js", "React", "TypeScript", "AI", "Agentic AI", "LangChain", "AWS", "India"],
