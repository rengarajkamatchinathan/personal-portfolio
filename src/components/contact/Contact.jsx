...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_wujfppt', 'template_6wizudt', form.current, '0mkOsld4uolZ3enJe')
        e.target.reset();
    };
            ...
            <div className="contact__content">
                ...
                <div className="contact__info">
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">rengaraj02k@gmail.com</span>
            ...
            <div className="contact__content">
                ...
                <form ref={form} onSubmit={sendEmail} className="contact__form">
                    ...
                    <div className="contact__form-div contact__form-area">
                        ...
                        <textarea name="project" cols="30" rows="10" className="contact__form-input" placeholder="Type your message here..."></textarea>
                    </div>
