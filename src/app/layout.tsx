...
export const metadata: Metadata = {
  title: "Rengaraj K",
  description:
    "Rengaraj Kamatchinathan is a proficient Software Engineer and Full Stack Developer from India, skilled in front-end and back-end development using modern tech stacks.",
  robots: {
    index: true,
    follow: true,
    googleBot: {
  ...
  keywords: [
    ...
    "indian developer",
    "rengaraj kamatchinathan github",
  ],
};
